...
function emacs@ {
  ...
  ln -s "~/Developer/etc/emacs/src/.emacs" ~/.emacs
  ln -s "~/Developer/dat/emacs" ~/.emacs.d
}
...
function rmc {
 rm -rf ~/.cache/common-lisp/lw-8.0.1-macosx-arm64/Users/ebzzry/Developer/src/lispo/{veda,vera,vega,marie,pierre,valmiz}
}
...
funs=(
  ...
  dtemplates "d ${HOME}/Developer/src/templates/"
  ...
  # purigado
  cleanup@ "brew@; nix@; =rm -rf ~/.Trash/*; 0"
); def_funs
