...
def_getter ys y.txt $YOUTUBE --write-sub --sub-lang en --sub-format srt --skip-download
def_getter yas y.txt $YOUTUBE --write-auto-sub --sub-lang en --sub-format srt --skip-download
map def_mapper y ya ys yas
