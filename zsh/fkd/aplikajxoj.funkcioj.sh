...
function sc () {
  screen -S $1 -dm ${argv[2,-1]}
}

function youtube-dl () {
  local bin=$HOME/bin/youtube-dl
  local cmd=$1
...
funs=(
  ...
  # haskelo
  ghci! "stack ghci"
  ghci@ "d \$HOME/hejmo/fkd/haskelo/nix-shell baf shell --run ghci"
  ...
  wallpaper! "d ~/common-lisp/wallpaper make install"
  ...
  # stumpwm
  dstumpwm "d $HOME/common-lisp/stumpwm"
  dstumpo "d $HOME/common-lisp/stumpo"
  stumpo! "+ dstumpo make"
  dmarie "dfkdlispo d marie"
  marie! "+ dmarie make"
  dcl "dfkdlispo"

  dql "d \$HOME/quicklisp/dists/quicklisp/software"
  delpa "d \$HOME/hejmo/ktp/emakso/var/elpa"
