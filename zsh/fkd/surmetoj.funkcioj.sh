...
function m () {
  ...
  if (( ! $# )); then
    ...
    if [[ -e "$1" ]]; then
      ...
      case $op in
        b0) mount_luks b0 9563ccc5-fb1c-4631-8ccc-ac4e53c1501b ;;
        b1) mount_luks b1 c55cd86f-1004-4c78-b122-94ecbedf72e7 ;;
        b2) mount_luks b2 c93eae32-1e9b-4895-aafc-14eaf8f822cf ;;
        elo) mount_elo $HOME/hejmo/dat/elo/kesto.elo ;;
        usb) mount_usb $@ ;;
        eusb) mount_eusb $@ ;;
        iso) mount_iso $@ ;;
        nfs) mount_nfs $@ ;;
