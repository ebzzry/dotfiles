...
c.url.searchengines["b"] = "https://duck.com/?q={}&t=h_&iax=images&ia=images"

## guglo
c.url.searchengines["g"] = "https://www.google.com/search?q={}"
c.url.searchengines["gi"] = "https://www.google.com/search?q={}&tbm=isch"
c.url.searchengines["gp"] = "https://play.google.com/store/search?q={}"
...
c.url.searchengines["a"] = "https://www.acronymfinder.com/~/search/af.aspx?Acronym={}&string=exact"
c.url.searchengines["t"] = "https://www.thesaurus.com/browse/{}"
...
## aliaj
c.url.searchengines["lg"] = "http://libgen.is/search.php?req={}&lg_topic=libgen&open=0&view=simple&res=25&phrase=1&column=def"
c.url.searchengines["bok"] = "https://b-ok.cc/s/?q={}"
c.url.searchengines["ab"] = "http://www.allitebooks.com/?s={}"
c.url.searchengines["mob"] = "https://forum.mobilism.org/search.php?keywords={}&sr=topics&sf=titleonly"
c.url.searchengines["epdf"] = "https://epdf.tips/search/{}"
c.url.searchengines["pdf"] = "https://www.pdfdrive.com/search?q={}&pagecount=&pubyear=&searchin=&more=true"

## krei-systems
c.url.searchengines["ks"] = "https://github.com/krei-systems/{}"
