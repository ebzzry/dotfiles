...
(def bind-comment-keys ()
  ...
  (map! :leader
        (:prefix-map (";" . "comment")
         :nv "o" nil
         :desc "Comment DWIM"              :nv "d" 'comment-dwim
         :desc "Comment operator"          :nv "c" 'evilnc-comment-operator
         :desc "Copy & comment operator"   :nv "y" 'evilnc-copy-and-comment-operator
         :desc "Comment line"              :nv "l" 'evilnc-comment-or-uncomment-lines
         :desc "Comment box"               :nv "b" 'evilnc-comment-box)))
