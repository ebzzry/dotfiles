...
(def bind-main-keys ()
  ...
  (map! :leader
        ...
        :desc "Mark the current line"     "_" 'mark-line
...
(def bind-org-keys ()
  ...
  (map! :leader
        :map org-mode-map
        :desc "Mark the current line"      "_" 'my-mark-org-line)
...
(def bind-sly-keys ()
  ...
  (map! :localleader
        ...
        (:prefix ("e" . "eval")
         ...
         :desc "Eval and overlay definition"    :n "d" 'sly-overlay-eval-defun
         ...
         :desc "Eval and print last expression" :n "E" 'sly-eval-print-last-expression
         :desc "Undefine function"              :n "u" 'sly-undefine-function)
        (:prefix ("c" . "compile")
         :n "C" nil :n "n" nil :n "l" nil
         :desc "Compile and load file"        :n "f" 'sly-compile-and-load-file
         :desc "Compile definition"           :n "d" 'sly-compile-defun
         :desc "Compile region"               :n "r" 'sly-compile-region)
        (:prefix ("x" . "extras")
         :desc "Switch to the REPL"           :n "r" 'my-switch-to-sly-mrepl-window
