...
(def-find eoligiloj (org-path "l.org"))
...
(def-find eqbmain "~/.qutebrowser/src/main.py")
(def-find eqbkeys "~/.qutebrowser/src/keys.py")
(def-find eqbsearch "~/.qutebrowser/src/search.py")
(def-find eqbthemes "~/.qutebrowser/src/themes.py")
(def-find eqbprivataj "~/.qutebrowser/src/privataj.py")
