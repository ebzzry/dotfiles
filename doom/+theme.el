...
(defgroup doom-ebzzry-theme nil
  "Options for the `doom-ebzzry' theme."
  :group 'doom-themes)

(defcustom doom-ebzzry-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to
determine the exact padding."
  :group 'doom-ebzzry-theme
  :type '(choice integer boolean))

(defcustom doom-ebzzry-muted-modeline nil
...
(defcustom doom-ebzzry-darker-background nil
...
(def-doom-theme doom-ebzzry
  ...
  (
   ...
   (bg         (if doom-ebzzry-darker-background -bg-alt -bg))
   (bg-alt     (if doom-ebzzry-darker-background -bg -bg-alt))
   ...
   (-modeline-pad
    (when doom-ebzzry-padded-modeline
      (if (integerp doom-ebzzry-padded-modeline) doom-ebzzry-padded-modeline 4)))

   (modeline-fg     green)
   (modeline-fg-alt vertical-bar)

   (modeline-bg
    `(,(car (if doom-ebzzry-muted-modeline (doom-darken teal 0.75) (doom-darken green 0.8)))
      ,@(cdr base0)))
...
;;; doom-ebzzry-theme.el ends here
