;;; ../hejmo/ktp/doom/shortcuts.el -*- lexical-binding: t; -*-


;;; ziŝo

(def-find ez (zsh-path "sl/zf"))
...
(def-find ds (spacemacs-path "."))
(def-find es (spacemacs-path "fkd/.spacemacs"))
(def-find esĝ (spacemacs-path "fkd/gxeneralajxoj.el"))
(def-find esb (spacemacs-path "fkd/bibliotekoj.el"))
(def-find esk (spacemacs-path "fkd/klavkombinoj.el"))
(def-find esŝ (spacemacs-path "fkd/sxparvojoj.el"))
(def-find est (spacemacs-path "fkd/transpasoj.el"))
(def-find esm (spacemacs-path "fkd/spacemacs.el"))


;;; lispo

(def-find emain "~/hejmo/ktp/lispo/main.lisp")
(def-find ecommon "~/hejmo/ktp/lispo/common.lisp")
(def-find elispworks "~/hejmo/ktp/lispo/lispworks.lisp")
(def-find esbcl "~/hejmo/ktp/lispo/sbcl.lisp")
...
(def-find ettt "~/hejmo/fkd/ttt/ebzzry.github.io")
(def-find ettteo "~/hejmo/fkd/ttt/ebzzry.github.io/fkd/eo")
(def-find ettten "~/hejmo/fkd/ttt/ebzzry.github.io/fkd/en")
(def-find escripts "~/hejmo/fkd/lispo/scripts/")
...
(def-find enixos "/sudo::/etc/nixos/configuration.nix")
(def-find ebarf "~/common-lisp/barf/barf.lisp")
...
(def-find etermite "~/.config/termite/config")
