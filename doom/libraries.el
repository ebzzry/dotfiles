...
;;    (add-to-list 'org-reveal-plugins 'audio-slideshow)
;;
...
(defun setup-libraries-startup ()
  (add-hook 'emacs-startup-hook '(lambda () (+global-word-wrap-mode +1))))


;;; top-level

(setup-libraries)
(setup-libraries-startup)
